#!/bin/bash -e
# All-in-one script to easily build any package in docker
...
#C=""; L="RUN $G"; E=""; Y="x"; H="# fixme" # comment out this line to make a portable Dockerfile suitable for dockerhub... when you've found all the dependencies
for B in $A; do 
  C=$(cat <<END
$C 
$L $B    $E
